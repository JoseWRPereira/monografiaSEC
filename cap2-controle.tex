...
Os sistemas físicos geralmente possuem um comportamento que pode ser descrito pela equação \ref{eq:ftSistOrdem1} , como é o caso da planta aqui estudada. 
...
\begin{figure}[!htb]
\center\includegraphics[scale=1]{./imagens/acaoMalhaAbertaTau.eps}
\caption{Ação de Controle em Malha Aberta}
\label{fig:acaoMalhaAberta}
\end{figure}

A Figura \ref{fig:acaoMalhaAberta} possui uma linha indicativa que mostra o ponto de intercepção da curva ao valor de 63\% do valor de referência, e empiricamente foi gerado um gráfico com divisões no eixo do Tempo no valor de $\tau = 2,8s $.
...
\begin{figure}[!htb]
\center\includegraphics[scale=1]{./imagens/acaoP.eps}
