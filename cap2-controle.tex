...
%\centering\includegraphics{./pic/C410processo.eps}
%\caption{Diagrama em bloco de sistema de controle}
%\label{fig:processo1}
%\end{figure}
...
Assim para uma combinação linear na entrada $u(t) = \alpha u_1(t) + \beta u_2(t)$ tem-se $y(t) = \alpha y_1(t) + \beta y_2(t), \forall \alpha ,  \beta \in \Re $ .
