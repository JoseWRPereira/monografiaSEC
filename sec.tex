...
\data{dd/mm/aaaa}
\palavraschave{Controle Não Convencional; Lógica Paraconsistente; Paracontrol; Controle Clássico;  }
\keywords{ Unconventional control; Paraconsistent logic; Paracontrol; Classic Controller; }
...
\chapter[Sistema eletrônico]{2. Sistema eletrônico}
\input{cap2-sistEletronico}

\chapter[Controle de Sistema]{3. Controle de Sistemas}
\input{cap3-controle}

\chapter[Apresentação e discussão dos resultado]{4. Apresentação e discussão dos resultados}
\input{cap4-desen}

\chapter[Considerações finais - Conclusão]{5. Considerações Finais - Conclusão}
