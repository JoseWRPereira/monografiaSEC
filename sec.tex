...
\CDU{003.3}
\areas{	1.Controle Clássico. 
	2.Controle Não-Convencional. 
...
\data{03/10/2017}
\palavraschave{Controle Clássico; Controle Não-Convencional; Lógica Paraconsistente; Paracontrol; }
\keywords{ Classic Controller; Unconventional control; Paraconsistent logic; Paracontrol; }
...
\setcounter{page}{17}
\chapter[Introdução]{\Large 1. Introdução}
\vspace{-1cm}
\input{cap1-intro}

\chapter[Sistema eletrônico]{\Large 2. Sistema eletrônico}
\vspace{-1cm}
\input{cap2-sistEletronico}

\chapter[Controle de Sistema]{\Large 3. Controle de Sistemas}
\vspace{-1cm}
\input{cap3-controle}

\chapter[Apresentação e discussão dos resultado]{\Large 4. Apresentação e discussão dos resultados}
\vspace{-1cm}
\input{cap4-desen}

\chapter[Considerações finais - Conclusão]{\Large 5. Considerações Finais - Conclusão}
\vspace{-1cm}
